...
function AboutSection() {
  ...
  return (
    <div id="about" className="my-12 lg:my-32 relative overflow-hidden">
      <div className="container mx-auto px-6 sm:px-12 lg:max-w-[70rem] xl:max-w-[76rem] 2xl:max-w-[92rem] relative">
